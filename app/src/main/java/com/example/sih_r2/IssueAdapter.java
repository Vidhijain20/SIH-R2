...
public class IssueAdapter extends RecyclerView.Adapter<IssueAdapter.MyViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull IssueAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    public IssueAdapter(Context context, ArrayList<IssueModel> arrayList)
    {
