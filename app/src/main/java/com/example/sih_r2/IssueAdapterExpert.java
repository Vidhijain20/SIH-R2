...
public class IssueAdapterExpert extends RecyclerView.Adapter<IssueAdapterExpert.MyViewHolder> {
...
@NonNull
@Override
public IssueAdapterExpert.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item, parent, false);
        return new MyViewHolder(view);
        }

@Override
public void onBindViewHolder(@NonNull IssueAdapterExpert.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
...
class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public IssueAdapterExpert(Context context, ArrayList<IssueModel> arrayList)
    {
