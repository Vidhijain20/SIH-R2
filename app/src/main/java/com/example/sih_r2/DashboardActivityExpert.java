...
public class DashboardActivityExpert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashboard_expert);
        ...
        IssueAdapterExpert issueAdapter = new IssueAdapterExpert(this, issueModelArrayList);
        ...
        resolvedButton.setBackgroundTintList(ContextCompat.getColorStateList(DashboardActivityExpert.this, R.color.white));
        resolvedButton.setTextColor(getColor(R.color.teal_700));
        pendingButton.setTextColor(getColor(R.color.white));
        pendingButton.setBackgroundTintList(ContextCompat.getColorStateList(DashboardActivityExpert.this, R.color.teal_700));
        ...
        pendingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                IssueAdapterExpert issueAdapter = new IssueAdapterExpert(getApplicationContext(), issueModelArrayList);
        ...
        resolvedButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                pendingButton.setBackgroundTintList(ContextCompat.getColorStateList(DashboardActivityExpert.this, R.color.white));
                pendingButton.setTextColor(getColor(R.color.teal_700));
                resolvedButton.setTextColor(getColor(R.color.white));
                resolvedButton.setBackgroundTintList(ContextCompat.getColorStateList(DashboardActivityExpert.this, R.color.teal_700));
